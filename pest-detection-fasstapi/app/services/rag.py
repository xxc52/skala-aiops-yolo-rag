...
from app.services.label_mapping import get_label_name
...
class RAG:
    ...
    async def forward(
        ...
        print(f"병해충 추론 결과 : {get_label_name(analysis_result)}")

        messages = await self.compose_prompt(mode, stt_text, target_lang, get_label_name(analysis_result))
        ...
        try:
            ...
            return f"오류 발생: {str(e)}", output_path